...
var ROLES_ADMIN_PERM_LABELS = {
  ...
  "foundation.read":            { group: "Integrations", label: "Read Foundation accounting data (jobs, contract values, labor hours)" },
  "foundation.refresh_jobs":    { group: "Integrations", label: "Refresh Foundation job list (job #/name only — no financials)" },
